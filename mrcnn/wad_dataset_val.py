...
class WadDatasetVal(utils.Dataset):
    """Generates the Amazon Shelf dataset.
    """

    #self.rootdir = '/Users/antoniotantorres/workspace/cs230/project/benchmark/office/test/shelf'
    ...
    def __init__(self,class_map=None):
    	...
    	self.filelist = get_filelist(self.datadir,'val')
